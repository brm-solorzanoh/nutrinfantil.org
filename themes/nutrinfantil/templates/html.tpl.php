...
<?php print $polyfills; ?>
  ...
  <link href="http://fonts.googleapis.com/css?family=Varela+Round|Roboto:400italic,300,700,400" rel="stylesheet" type="text/css">
</head>
<body class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <script>
    var myCenter=new google.maps.LatLng(4.707952,-74.050133);
    var myCenterPin=new google.maps.LatLng(4.708892, -74.064432);
    var marker;
    function initialize() {
      var mapProp = {
        center:myCenter,
      ...
      var marker=new google.maps.Marker({
        position:myCenterPin,
        animation:google.maps.Animation.DROP,//BOUNCE
        icon:'sites/all/themes/nutrinfantil/images/pin.png'
      });

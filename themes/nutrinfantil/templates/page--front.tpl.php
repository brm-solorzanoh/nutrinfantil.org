...
?>
  ...
  <section class="container-fluid l-home">
    <div class="row">
      ...
      <!--dona aquí-->
      <?php $block = module_invoke('BRM_nutrinfantil', 'block_view','frase_home_block');
        print render($block['content']); 
      ?>
      <!--contenido-->
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="container">
          <div class="row">
            <!--la fundacion-->
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fundacion">
              <div class="u-title u-title-centro">
                <h1>LA FUNDACIÓN</h1>
                <div class="u-cuadrito u-cuadrito-amarillo"></div>
              </div>
              <ul>
                <li class="active"><a href="historias"><span class="icono icono-libro"></span>Historias</a></li>
                <li><a href="nuestras-sedes"><span class="icono icono-casa"></span>Nuestras sedes</a></li>
                <li><a href="contenido-actividades"><span class="icono icono-puzzle"></span>Actividades</a></li>
                <li><a href="nuestros-comedores"><span class="icono icono-comida"></span>Nuestros comedores</a></li>
                <li><a href="plan-padrinos"><span class="icono icono-personas"></span>Plan padrinos</a></li>
              </ul>
            </div>
            <!--multimedia+fabebook -->
            <?php $block = module_invoke('slider_home', 'block_view','videos_home');
              print render($block['content']); 
            ?>
            <!--actividades-->
            <?php $block = module_invoke('BRM_nutrinfantil', 'block_view','eventos_home_block');
              print render($block['content']); 
            ?>
          </div>
        </div>
